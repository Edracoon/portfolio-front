...
import { CPlusPlus, React, TailwindCSS, NodeJs } from "developer-icons";
import env from "@/env";
...
export function Chess42Card(props: React.HTMLAttributes<HTMLDivElement>) {
    return (
        <ProjectCard
            ...
            className="w-full"
            title="42-Chess"
            links={[{ label: "github", href: "https://github.com/Edracoon/42Chess" }, { label: "play", href: env.GOMOKU_URL! }]}
            body={
            ...
            techStack={[CPlusPlus, NodeJs, React, TailwindCSS]}
            infoList={[
